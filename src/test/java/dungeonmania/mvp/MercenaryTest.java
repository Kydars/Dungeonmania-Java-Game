...
public class MercenaryTest {
    ...
    @Test
    @Tag("12-6")
    @DisplayName("Testing a mercenary cannot be bribed outside a radius")
    ...
    @Test
    @Tag("12-8")
    @DisplayName("Test allied Mercenary follows adjacent player")
    public void alliedMovementFollow() {
        DungeonManiaController dmc = new DungeonManiaController();
    ...
    @Test
    @Tag("12-9")
    @DisplayName("Test allied Mercenary approaches stationary player")
    public void alliedMovementApproach() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_allyMovement", "c_mercenaryTest_allyBattle");
    ...
    @Test
    @Tag("12-10")
    @DisplayName("Test allied Mercenary occupies previous square of player after approaching them")
    public void alliedMovementApproachThenFollow() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_allyMovement", "c_mercenaryTest_allyBattle");
